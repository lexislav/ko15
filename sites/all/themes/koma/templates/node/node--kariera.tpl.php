                  ...
                  <div class="m-contact-form--content">
                      <form class="webform-client-form webform-client-form-1602" enctype="multipart/form-data" action="<?= $form['#action'] ?>" method="post" id="webform-client-form-1602" accept-charset="UTF-8">
                          <div>
                              ...
                              <input required="required" type="checkbox" id="edit-submitted-souhlasim-1" name="submitted[souhlasim][souhlasim]" value="souhlasim" class="form-checkbox" required>  <label class="option" for="edit-submitted-souhlasim-1"><?=$form['submitted']['text']['#markup']?></label>
