...
<div style="background-color: deeppink; padding: 30px; color:white; text-align: center"> aaaaaaa Sekce na hp rentu, 3 bloky, titulek, podtitulek, button.</div><!-- konec sekce s karuselem -->
...
<div class="m-section" <?php koma_theme_wrapper(__FILE__) ?>>
    ...
    <article>
        <div class="row">
            ...
            <!-- 2/2-->
            <div class="l-half">
                <div class="m-item--image" style="background-image: url(https://www.koma-modular.cz/sites/default/files/styles/x618-480/public/soubory/fotogalerie/reference//uvodni?itok=_rvgewtr)">
                    <a href=""><img src="https://www.koma-modular.cz/sites/default/files/styles/x618-480/public/soubory/fotogalerie/reference//uvodni?itok=_rvgewtr" alt=""></a>
                </div>
            </div>
        </div>
