...
if(empty($_POST['lastname'])){
  ...
  test_mail('info@koma-saustriapace.at', $mailfrom, 'Nová zpráva - kontaktní formulář KOMA', $name . "\n" . $text);
  ?>
                ...
                <header>
                    ...
                    <div class="m-item--summary">
                        <h1 class="m-item--hed mm-center">
                            ...
                            <a href="https://www.koma-austria.at/de/kariera/verkaeufer-im-aussendienst-mw-b2b-vertrieb-wien-niederoesterreich"><?php print t('Kariéra v KOMA') ?></a>
                        </h1>
                        ...
                        <div class="m-card--more bg-8">
                            <?php /* <a href="<?= test_lang_prefix('firma-a-lide/kariera') ?>" */ ?>
                            <a href="https://www.koma-austria.at/de/kariera/verkaeufer-im-aussendienst-mw-b2b-vertrieb-wien-niederoesterreich"
