...
<div class="m-section l-feed_three <?=$modificatiorClass?>" <?php koma_theme_wrapper(__FILE__)?>>
    <div class="row rowfix">
        ...
        foreach ($items AS $poradi => $cast) {
            ...
            $target_id = ($element['#object']->field_or_odkazy[test_lang_code()][$poradi]['field_ereference_segment']['und'][0]['target_id']);
    ...
    <div class="row">
        <footer class="m-section--footer">
            ...
            <div class="m-section--more">
                  ...
                  <a href="<?= test_basic_url() ?>referezen/archiv"><?php print t('WHOLE ARCHIVES') ?> &rarr;</a>
