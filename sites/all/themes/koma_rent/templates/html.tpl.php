...
<head class="rent">
    ...
    <script src="https://www.koma-rent.cz/sites/all/themes/koma/js/komacookies.js" async></script>
    <script>
        var koma_eu_config = {
            "l18n": {
                <?php
                ...
                "link": "https://www.koma-rent.cz/en/informations-about-cookies"
                <?php
                ...
                "link": "https://www.koma-rent.cz/de/cookies"
                <?php
                }
                ?>
            }
