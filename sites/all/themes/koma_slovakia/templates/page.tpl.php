        ...
        <div class="m-navbar--container">
          ...
          <ul class="m-navbar--menu m-navbar--menu-primary">
            <li class="m-navbar--menu-callout">
              <span class="color-primary">Zavolajte nám:</span> (+421) 37 6518 325</li>
          </ul>
        ...
        <div class="m-navbar--container">
            ...
            <a class="m-navbar--logo" href="<?= $front_page ?>">
                <div class="mm-has-svg"
                     style="background-image: url('<?= $GLOBALS['base_url'] ?>/sites/all/themes/koma_slovakia/logo.svg');"></div>
            </a>
        ...
        <div class="row">
            <section class="m-footer--section">
                <a class="m-footer--logo" href="/">
                    <img src="<?= $GLOBALS['base_url'] ?>/sites/all/themes/koma_slovakia/logo-koma-slovakia-inline-white.svg" alt="" />
                </a>
            </section>
            <section class="m-footer--section">
