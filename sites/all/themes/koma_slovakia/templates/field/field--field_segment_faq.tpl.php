        ...
        <footer class="m-section--footer">
            ...
            <div class="l-half">
                <ul class="m-section--nav inline-right">
                    <li><a href="<?= test_basic_url() ?>znalostni-baze?field_knowledgebase_kategorie_tid=121">FAQ – ČASTO KLADENÉ DOTAZY</a></li>
                    <li><a href="<?= test_basic_url() ?>znalostni-baze?field_knowledgebase_kategorie_tid=227">TECHNICKÁ POMOC</a></li>

                    <li><a href="<?= test_basic_url() ?>znalostni-baze?field_knowledgebase_kategorie_tid=228" title="">PRONÁJMY</a></li>
