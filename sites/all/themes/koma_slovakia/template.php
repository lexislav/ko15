...
//function koma_slovakia_preprocess_page(&$variables) {
//    echo '<pre>'; var_dump($variables['theme_hook_suggestions']); echo '</pre>';
//}
function koma_slovakia_links__locale_block(&$variables) {
...
function koma_slovakia_menu_breadcrumb_alter(&$active_trail, $item) {
    global $language ;
...
function koma_slovakia_theme() {
    $items = array();

    $items['user_login'] = array(
        'render element' => 'form',
        'path' => drupal_get_path('theme', 'koma_slovakia') . '/templates',
        'template' => 'user-login',
        'preprocess functions' => array(
            'koma_slovakia_preprocess_user_login'
        ),
    );
    $items['user_register_form'] = array(
        ...
        'preprocess functions' => array(
            'koma_slovakia_preprocess_user_register_form'
        ),
    );
    $items['user_pass'] = array(
        ...
        'template' => 'user-pass',
        'preprocess functions' => array(
            'koma_slovakia_preprocess_user_pass'
        ),
    );
    return $items;
}

function koma_slovakia_preprocess_user_login(&$vars) {
    $vars['intro_text'] = t('This is my awesome login form');
}

function koma_slovakia_preprocess_user_register_form(&$vars) {
    $vars['intro_text'] = t('This is my super awesome reg form');
}

function koma_slovakia_preprocess_user_pass(&$vars) {
    $vars['intro_text'] = t('This is my super awesome request new password form');
}
function koma_slovakia_menu_local_tasks(&$variables) {
    $output = '';
