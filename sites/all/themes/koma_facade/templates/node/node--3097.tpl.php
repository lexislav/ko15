<style>
    ...
    .m-contact.mm-contanct-override a:hover {
        color: rgb(194, 14, 26);
...
<div class="m-section l-detail-page" <?php koma_theme_wrapper(__FILE__) ?>>
    ...
    <article class="m-contact mm-contanct-override">
        <header>
            ...
            <div class="l-half l-half-mobile-full">
                ...
                <?php }
                    ...
                    <div class="m-section" id="formSection" <?php koma_theme_wrapper(__FILE__) ?>>
                        <div class="row">
                            <header class="m-section--header pt-0">
                                <div class="l-full">
                        ...
                        <div class="row">
                            <div class="m-contact-form mm-full">
                                <header>
