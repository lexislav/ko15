...
<div class="hero-tabs mm-six" slick <?php koma_theme_wrapper(__FILE__)?>>
  <div class="hero-slides" carousel>
    ...
    foreach ($pole_slider as $cislo => $r) {
      ...
      <?php } else { ?>
        <div class="content-tab <?php echo ($cislo <= 4) ? '' : 'mm-right'; ?>" style="background-image: url(<?= image_style_url('none', $uri) ?>);">
          <div class="row">
            <div class="description">
              <p><?= $r['field_basic_text']['und'][0]['value'] ?></p>
            </div>
